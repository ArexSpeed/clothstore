  ...
  return (
    <div className="w-72 min-w-max h-xl p-2 m-2 rounded-3xl border flex flex-col justify-between border-gray-100">
      <div className="relative h-3/4 w-full">
        ...
        <button className="absolute flex justify-center items-center top-4 right-4 w-8 h-8 rounded-xl bg-gray-200 bg-opacity-50">
        ...
        <button className="absolute flex justify-center items-center bottom-4 left-4 w-8 h-8 rounded-xl bg-gray-200 bg-opacity-50">
