      ...
      <section>
        ...
        <ul className="w-full">
          ...
          >
            ...
            <div className={`sidebar-link-dot ${pathname === '/' && 'bg-green-300'}`}></div>
          </Link>
          <li className="sidebar-link">
            <div className="flex">
              ...
              <span className="mx-4 group-hover:font-semibold">Sale</span>
            </div>
            <div className="sidebar-link-dot group-hover:bg-red-300"></div>
          </li>
          <li className="sidebar-link">
            <div className="flex">
              ...
              <span className="mx-4 group-hover:font-semibold">Clothing</span>
            </div>
            <div className="sidebar-link-dot group-hover:bg-red-300"></div>
          </li>
          <li className="sidebar-link">
            ...
            <svg className="w-5 h-5 text-green-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4" /></svg>
              <span className="mx-4 group-hover:font-semibold">Shoes</span>
            </div>
            <div className="sidebar-link-dot group-hover:bg-red-300"></div>
          </li>
          <li className="sidebar-link">
            <div className="flex">
              ...
              <span className="mx-4 group-hover:font-semibold">Accessories</span>
            </div>
            <div className="sidebar-link-dot group-hover:bg-red-300"></div>
          </li>
          <li className="sidebar-link">
            <div className="flex">
              ...
              <span className="mx-4 group-hover:font-semibold">Inspiration</span>
            </div>
            <div className="sidebar-link-dot group-hover:bg-red-300"></div>
          </li>
          <li className="sidebar-link">
            <div className="flex">
              ...
              <span className="mx-4 group-hover:font-semibold">Outlet</span>
            </div>
            <div className="sidebar-link-dot"></div>
          </li>
        </ul>
      </section>
    </div>
