...
const Sidebar = () => {
  ...
  return (
    <div className="p-4 flex flex-col justify-between items-start w-64 max-w-xs h-full min-h-screen shadow-md">
      <div className="w-full flex flex-col justify-center items-start">
        ...
        <section>
          ...
          <ul className="w-full">
            <Link to="/" className="w-full py-3 group flex flex-row justify-between items-center text-sm cursor-pointer">
              <div className="flex">
